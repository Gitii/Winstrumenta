...
public class DebianVersionTests
{
    ...
    {
        new object?[] { "1:1.4.1-1", 1u, "1.4.1", "1" },
        new object?[] { "7.1.ds-1", 0u, "7.1.ds", "1" },
        ...
        new object?[] { "1.5+E-14", 0u, "1.5+E", "14" },
        new object?[] { "20060611-0.0", 0u, "20060611", "0.0" },
        new object?[] { "0.52.2-5.1", 0u, "0.52.2", "5.1" },
        new object?[] { "7.0-035+1", 0u, "7.0", "035+1" },
        ...
        new object?[] { "1.8RC4b", 0u, "1.8RC4b", null },
        new object?[] { "0.9~rc1-1", 0u, "0.9~rc1", "1" },
    ...
    private static readonly object[] VersionComparisonTestSources =
    {
        ...
        new object?[] { "1.0", "<", "1.1" },
        new object?[] { "1.2", "<", "1.11" },
        new object?[] { "1.0-0.1", "<", "1.1" },
        new object?[] { "1.0-0.1", "<", "1.0-1" },
        new object?[] { "1.0", "==", "1.0" },
        new object?[] { "1.0-0.1", "==", "1.0-0.1" },
        new object?[] { "1:1.0-0.1", "==", "1:1.0-0.1" },
        new object?[] { "1:1.0", "==", "1:1.0" },
        new object?[] { "1.0-0.1", "<", "1.0-1" },
        new object?[] { "1.0final-5sarge1", ">", "1.0final-5" },
        new object?[] { "1.0final-5", ">", "1.0a7-2" },
        new object?[] { "0.9.2-5", "<", "0.9.2+cvs.1.0.dev.2004.07.28-1.5" },
        new object?[] { "1:500", "<", "1:5000" },
        new object?[] { "100:500", ">", "11:5000" },
        new object?[] { "1.0.4-2", ">", "1.0pre7-2" },
        new object?[] { "1.5~rc1", "<", "1.5" },
        new object?[] { "1.5~rc1", "<", "1.5+b1" },
        new object?[] { "1.5~rc1", "<", "1.5~rc2" },
        new object?[] { "1.5~rc1", ">", "1.5~dev0" },
    };

    [TestCaseSource(nameof(VersionComparisonTestSources))]
    public void ShouldCompareVersion(
        string leftRawVersion,
        string comparisonOperator,
        string rightRawVersion
    )
    {
        var left = new DebianVersion(leftRawVersion);
        var right = new DebianVersion(rightRawVersion);

        GetVersionComparator<DebianVersion>(comparisonOperator)(left, right)
            .Should()
            .BeTrue($"{leftRawVersion} {comparisonOperator} {rightRawVersion}");
    }
