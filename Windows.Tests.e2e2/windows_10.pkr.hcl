...
source "hyperv-iso" "win10" {
  ...
  boot_wait                        = "-1s"
  cd_files                         = ["./answer_files/10_efi/Autounattend.xml", "./scripts/fixnetwork.ps1", "./scripts/disable-screensaver.ps1", "./scripts/disable-winrm.ps1", "./scripts/enable-winrm.ps1", "./scripts/microsoft-updates.bat", "./scripts/win-updates.ps1"]
  communicator                     = "winrm"
...
build {
  sources = ["source.hyperv-iso.win10"]
