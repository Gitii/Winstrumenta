    ...
    public class DesktopWindow : Window, INativeWindowListener
    {
        ...
        public DynamicApplicationTheme RequestedTheme
        {
            ...
            set
            {
                ...
                {
                    ApplyTheme(Microsoft.UI.Xaml.ApplicationTheme.Dark);
                }
                else
                {
                    ApplyTheme(Microsoft.UI.Xaml.ApplicationTheme.Light);
                }
            }
        }

        private void ApplyTheme(Microsoft.UI.Xaml.ApplicationTheme applicationTheme)
        {
            if (Content is FrameworkElement elem)
            {
                switch (applicationTheme)
                {
                    ...
                    case ApplicationTheme.Dark:
                        ...
                        break;
                    default:
                        throw new ArgumentOutOfRangeException(nameof(applicationTheme), applicationTheme, null);
                }
            }
        }
        ...
        public void Activated(NativeWindow nativeWindow)
        {
            if (_loaded) return;
        ...
        public void OnSystemThemeChanged(NativeWindow nativeWindow, Windows.UI.Color foreground,
